			...
			<link rel="stylesheet"
				...
				<link rel="stylesheet"
					...
					<link rel="stylesheet"
						...
						<title>会员中心--提交作业</title> <script type="text/javascript">
		function check(form){
					...
					<div class="u_form1">
						<div style="text-align: center">
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
								<tr align="center">
									<td id="TabTitle0" class="titlemouseover">提交作业</td>
								</tr>
							</table>
							<form action="<c:url value="/master/homework.do?m=submit"/>"
								...
								<table class="border" id="EgvContent" style="width: 100%;"
									...
									<tr class="tdbg" align="center">
										<td height="25" width="20%" align="right"
											style="padding-right: 8px">题目:</td>
										<td align="left" style="padding-left: 8px"><c:out
												value="${entity.title}" /></td>
									</tr>
									<tr class="tdbg" align="center">
										<td height="25" align="right" style="padding-right: 8px">发布时间:</td>
										<td align="left" style="padding-left: 8px"><f:formatDate
												value="${entity.time}" pattern="yyyy-MM-dd HH:mm" /></td>
									</tr>
									<tr class="tdbg" align="center">
									...
									<tr class="tdbg" align="center">
										...
										<td align="left" style="padding-left: 8px"><input
											type="submit" value="提交作业" /> <input type="button"
											value="返回" onclick="javascript:history.back(-1);" /> <input
											type="hidden" name="titleId" value="${entity.id}" /></td>
									</tr>
								</table>
							</form>
						</div>
