					...
					<div class="u_form1">
						<div style="text-align: center">
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
								<tr align="center">
									<td id="TabTitle0" class="titlemouseover">作业题目列表</td>
								</tr>
							</table>
							<table class="border" id="EgvContent" style="width: 100%;"
								...
								<c:choose>
									<c:when test="${not empty homeworktitleList}">
										<c:forEach items="${homeworktitleList}" var="hwt"
											varStatus="vs">
											<tr class="tdbg" align="center">
												<td height="22"><c:out value="${vs.index+1}" /></td>
												<td align="left" style="font-weight: bold;"><a
													href="<c:url value="/master/homework.do?m=titleDetail&id=${hwt.id}"/>"><c:out
															value="${hwt.title}" /></a></td>
												<td align="center"><f:formatDate value="${hwt.time}"
												...
												<td align="center" style="font-weight: bold;"><a
													href="<c:url value="/master/homework.do?m=titleDetail&id=${hwt.id}"/>">提交作业</a>
												</td>
											</tr>
										</c:forEach>
									</c:when>
