...
<title>后台管理--<c:choose>
		<c:when test="${empty newsEntity}">发布新闻</c:when>
		<c:otherwise>编辑新闻</c:otherwise>
	</c:choose></title>
	...
	<div class="content">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td valign="top">
					<div class="right">
						<form action="<c:url value="/admin/news/pubnews.do?m=dopub"/>"
							...
							<table width="80%" border="0" cellpadding="0" cellspacing="1"
										...
										name="menuId" id="menuId">
											...
											<c:forEach items="${menuList}" var="menu">
												<option value="${menu.id}"
													${newsEntity.newsMenu.id==menu.id?'selected=selected':''}><c:out
								...
								<tr>
									...
									<td height="28" bgcolor="#FFFFFF"><input type="text"
										name="title" id="title" size="60" value="${newsEntity.title}"
										maxlength="25" />
									<p>请输入新闻标题</p></td>
								</tr>
								<tr>
									...
									<td height="28" bgcolor="#FFFFFF"><input type="text"
										...
										value="<c:out value="${newsEntity.author}" default="admin"/>"
										maxlength="10" />
									<p>请输入新闻作者</p></td>
								</tr>
								<tr>
									...
									<td height="28" bgcolor="#FFFFFF"><input type="text"
										name="source" value="${newsEntity.source}" maxlength="10" />
									<p>请输入新闻来源</p></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td height="28" bgcolor="#FFFFFF"><textarea name="content"><c:out
												value="${newsEntity.content}" escapeXml="false" /></textarea>
										<p>请输入新闻内容</p></td>
								</tr>
							</table>
							<div class="anniu">
								<p>
									<input type="submit" value="提交" class="fabu" /> <input
										type="reset" value="重置" class="fabu" />
								</p>
