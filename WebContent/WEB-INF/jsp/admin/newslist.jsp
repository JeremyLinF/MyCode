									...
									<c:forEach items="${newsList}" var="news" varStatus="vs">
										<tr>
											<td height="30" bgcolor="#FFFFFF" align="center"><input
												type="checkbox" name="newsId" value="${news.id}" /> <c:out
													value="${vs.index+1}" /></td>
											<td height="30" bgcolor="#FFFFFF" align="left"
												style="padding-left: 10px;"><a
												href="<c:url value="/news/see.do?id=${news.id}"/>"
												target="_blank"><c:out value="${news.title}" /></a></td>
											<td height="30" bgcolor="#FFFFFF" align="center"><f:formatDate
													value="${news.pubtime}" pattern="yyyy-MM-dd HH:mm" /></td>
											<td height="30" bgcolor="#FFFFFF" align="center"><c:out
													value="${news.viewNum}" /></td>
											...
											<td width="10%" height="30" bgcolor="#FFFFFF" align="center">
												<a
												href="<c:url value="/admin/news/news.do?m=edit&id=${news.id}"/>">修改</a>
