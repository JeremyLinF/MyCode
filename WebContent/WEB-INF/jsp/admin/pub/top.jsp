			...
			<c:choose>
				<c:when test="${not empty m}">
					<c:choose>
						...
						<c:otherwise>
							<li><a href="<c:url value="/admin/index.do"/>">首页</a></li>
						</c:otherwise>
					</c:choose>
					<c:choose>
						<c:when test="${m=='news'}">
						...
						<c:otherwise>
							<li><a href="<c:url value="/admin/index.do?m=news"/>">新闻</a></li>
						</c:otherwise>
					</c:choose>
					<c:choose>
						<c:when test="${m=='clazz'}">
						...
						<c:otherwise>
							<li><a href="<c:url value="/admin/index.do?m=clazz"/>">课程中心</a></li>
						</c:otherwise>
					</c:choose>
					<c:choose>
						<c:when test="${m=='source'}">
							<li class="bj">资源下载</li>
						</c:when>
						<c:otherwise>
							<li><a href="<c:url value="/admin/index.do?m=source"/>">资源下载</a></li>
						</c:otherwise>
					</c:choose>
					<c:choose>
						<c:when test="${m=='topic'}">
						...
						<c:otherwise>
							<li><a href="<c:url value="/admin/index.do?m=topic"/>">互动交流</a></li>
						</c:otherwise>
					</c:choose>
				</c:when>
				<c:otherwise>
