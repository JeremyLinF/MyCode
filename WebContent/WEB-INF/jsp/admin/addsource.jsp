...
<title>后台管理--<c:choose>
		<c:when test="${empty sourceEntity}">发布资源</c:when>
		<c:otherwise>编辑资源</c:otherwise>
	</c:choose></title>
	...
	<div class="content">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td valign="top">
					<div class="right">
						<form action="<c:url value="/admin/source/source.do?m=doadd"/>"
							...
							<table width="80%" border="0" cellpadding="0" cellspacing="1"
								...
								<tr>
									...
									<td height="28" bgcolor="#FFFFFF"><select name="menuId"
										id="menuId">
											<option value="0">请选择目录</option>
											<c:forEach items="${menuList}" var="menu">
												<option value="${menu.id}"
													${sourceEntity.sourceMenu.id==menu.id?'selected=selected':''}><c:out
								...
								<tr>
									<tr>
										...
										<td height="28" bgcolor="#FFFFFF"><input type="text"
											name="name" id="name" size="60" value="${sourceEntity.name}" />
										<p>请输入资源名称</p></td>
									</tr>
									<tr>
										...
										<td height="28" bgcolor="#FFFFFF"><input type="text"
											...
											value="${sourceEntity.fileSize}" maxlength="10" />
										<p>请输入资源文件大小</p></td>
									</tr>
									<tr>
										...
										<td height="28" bgcolor="#FFFFFF"><input type="file"
											name="file" id="file" />
											<p>
												请上传资源文件,只能为<span style="color: red">doc、xls、ppt、txt、rar、zip</span>格式
											</p></td>
									</tr>
							</table>
							<div class="anniu">
