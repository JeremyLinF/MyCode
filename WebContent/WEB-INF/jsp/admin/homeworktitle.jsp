...
<body>
	<div class="content">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td class="left" valign="top"><jsp:include page="pub/left.jsp"></jsp:include>
				</td>
				<td valign="top">
					<div class="middle">
							...
							<table width="99%" border="0" cellpadding="0" cellspacing="1"
								...
								<tr>
									<td height="30" bgcolor="#ffffff" align="center"><input
										...
										type="text" name="key" value="${key}" /> <input type="submit"
										value="搜索" /> <input type="button" value="添加题目"
										onclick="location='<c:url value="/admin/homework.do?m=addTitle"/>'" />
									</td>
								</tr>
							</table>
						</form>
					...
					<div id="c01">
						<table width="99%" border="0" cellpadding="0" cellspacing="1"
							...
							<tr>
								...
								<td width="50%" height="30" bgcolor="#e5edfa"><div
									...
									<c:forEach items="${homeworktitleList}" var="hw" varStatus="vs">
										<tr>
											...
											<td bgcolor="#FFFFFF" align="center"><a
												href="<c:url value="/admin/homework.do?m=list&titleId=${hw.id}"/>"><c:out
														value="${hw.title}" /></a></td>
											<td bgcolor="#FFFFFF" align="center"><f:formatDate
													value="${hw.time}" pattern="yyyy-MM-dd HH:mm" /></td>
											<td bgcolor="#FFFFFF" align="center"><a
												href="<c:url value="/admin/homework.do?m=editTitle&id=${hw.id}"/>">修改</a>&nbsp;&nbsp;
												<a href="javascript:del(${hw.id})">删除</a>&nbsp;&nbsp; <a
												href="<c:url value="/admin/homework.do?m=titleDetail&id=${hw.id}"/>">详细</a>&nbsp;&nbsp;
												<a
												href="<c:url value="/admin/homework.do?m=list&titleId=${hw.id}"/>">查看作业</a>
											</td>
										</tr>
									</c:forEach>
								</c:when>
